...
class Budget_Controller extends Controller
{
	...
	function __construct()
	{
		...
		// set theme
		$this->template->set_theme('budget');
		
		// set layout
		$this->template->set_layout('layout');
		
		// set title
		$this->template->title('ระบบบงานริหารราชการ ระบบจัดทำคำของบประมาณ (Budgeting System) กระทรวงการพัฒนาสังคมและความมั่นคงของมนุษย์');
