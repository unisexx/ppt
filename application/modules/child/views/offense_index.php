...
<div id="search">
  <div id="searchBox">
    ...
    <select name="select2" id="select2">
      <option selected="selected">-- ทุกเขตจังหวัด --</option>
...
<div id="btnBox"><input type="button" title="นำเข้าข้อมูล"  value=" " onclick="document.location='people.php?act=import'" class="btn_import"/><input type="button" title="เพิ่มรายการ"  value=" " onclick="document.location='child/offense_form'" class="btn_add"/></div>
