...
<form action='disability/disabled/save/<?=$m['id'];?>/' method='POST'>
<?php endif; ?>
	...
	<tr>
	  ...
	  <td><? echo form_dropdown('WLIST_ID', get_option('id', 'name', 'disabled_list'), @$result['wlist_id'], null, '-- กรุณาเลือกสถานสงเคราะห์ --'); ?>	</td>
	</tr>
	<?
