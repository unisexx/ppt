...
<form method="get" action="disablefund/report_people1">
<div id="search">
  <div id="searchBox">
    <select name="year">
...
<a href="disablefund/export_people1?year=<?=$_GET['year']?>"><img src="themes/ppt/images/excel.png" width="32" height="32" style="margin-bottom:-6px" class="vtip" title="ส่งออกข้อมูล"></a>
