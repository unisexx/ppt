<?php
Class medium extends Public_Controller
{
	...
	function index(){
		...
		$this->template->build('medium/index',$data);
	}
	...
	function form($id=FALSE){
		...
		$this->template->build('medium/form',$data);
	}
    
    function save(){
    	$_POST['key_id'] = $this->key_id;
    	$this->family->save($_POST);
		redirect('family/medium/index');
    }
	...
	function import_form(){
		...
		$this->template->build('medium/import_form',$data);
	}
	function import(){
//		$this->db->debug = true;
