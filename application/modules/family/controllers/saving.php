<?php
Class saving extends Public_Controller
{
	...
	function index(){
		...
		$this->template->build('saving/index',$data);
	}
	...
	function form($id=FALSE){
		...
		$this->template->build('saving/form',$data);
	}
    
    function save(){
    	$_POST['key_id'] = $this->key_id;
    	$this->family->save($_POST);
		redirect('family/saving/index');
    }
	...
	function import_form(){
		...
		$this->template->build('saving/import_form',$data);
	}
	function import(){
//		$this->db->debug = true;
