...
<div id="search">
    <form method="get" action="family/violence">
...
<div id="btnBox">
    <input type="button" title="เพิ่มรายการ" value=" " onclick="document.location='<?php echo site_url('family/violence_form'); ?>'" class="btn_add">
</div>
...
<table class="tblist">
    ...
    <tr>
        ...
        <td>
            <input type="submit" title="แก้ไขรายการนี้" value=" " class="btn_edit vtip"  onclick="window.location='<?php echo site_url('family/violence_form/'.$item['id']); ?>'" />
            <input type="submit" title="ลบรายการนี้" value=" " class="btn_delete vtip" onclick="if(confirm('ยืนยันการลบ')){window.location='<?php echo site_url('family/violence_delete/'.$item['id']); ?>';}" />
        </td>
    </tr>
    <?php endforeach; ?>
</table>
