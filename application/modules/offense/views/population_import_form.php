...
<form method="post" enctype="multipart/form-data" action="offense/offense_import" id="frm_im" name="frm_im">
    <input type='hidden' name='ID' value='<?=@$result['id'];?>'>
    <table class="tbadd">
        <tr>
            <th>ปี, ปีงบประมาณ , ปีการศึกษา</th>
            <td><?php echo form_dropdown('year_data', get_year_option(2530), @$_GET['year_data'], null, '-- ทุกปี --'); ?></td>
        </tr>
<!--        <tr>
            <th>จังหวัด</th>
    ...
    function import_data()
    {
        ...
        if(conf)
        {
                    document.frm_im.action="offense/offense_import";
