...
<a href='healthcare/export2/<?php echo $this->uri->segment(3,0)?>?type=<?php echo $_GET['type']?>'><img src="themes/thesocial_demo/images/excel.png" width="32" height="32" style="margin-bottom:-6px" class="vtip" title="ส่งออกข้อมูล"></a>
