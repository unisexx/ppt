<h2>ข้อมูลกลุ่มเป้าหมาย - ผู้ด้อยโอกาส <a href="uploads/การให้ความช่วยเหลือ.xls"class="btn_ex_data"></a></h2>
...
<form action="recipient/save_import" method="post" enctype="multipart/form-data">
	<table class="tbadd">
		<tr>
			...
			<td><?php echo form_dropdown('year_data', get_year_option(2554), @$_GET['year_data'], null, '-- ทุกปี --'); ?></td>
		</tr>				
		<tr>
