...
class Dla extends Public_Controller
{
	...
	public function women()
    {
		...
		else
		{
			...
			$this->template->title('รายงานปัญหาสตรีในท้องถิ่น ระบบฐานข้อมูลทางสังคม สป.พม.');
			$this->template->append_metadata( meta('keywords','ระบบฐานข้อมูลทางสังคม,ระบบฐานข้อมูลด้านสังคม,ฐานข้อมูลด้านสังคม,ฐานข้อมูลทางสังคม,กลุ่มเป้าหมาย,เชิงประเด็น,สำนักงานปลัดกระทรวงการพัฒนาสังคมและความมั่นคงของมนุษย์,กระทรวงการพัฒนาสังคมและความมั่นคงของมนุษย์,พม.,สป.พม.,สป.,ข้อมูลด้านสังคม,ข้อมูลทางสังคม,ข้อมูลสังคม,สตรี,สภาพปัญหาสตรีในท้องถิ่น,สภาพปัญหาสตรี,สตรีในท้องถิ่น,ปัญหาสตรี,ละเมิดทางเพศ,ทำร้ายร่างกาย,ทำร้ายจิตใจ,สตรีหม้าย'));	
	...
	public function disabled()
    {
		...
		else
		{
			...
			$this->template->title('รายงานปัญคนพิการในท้องถิ่น ระบบฐานข้อมูลทางสังคม สป.พม.');
			$this->template->append_metadata( meta('keywords','ระบบฐานข้อมูลทางสังคม,ระบบฐานข้อมูลด้านสังคม,ฐานข้อมูลด้านสังคม,ฐานข้อมูลทางสังคม,กลุ่มเป้าหมาย,เชิงประเด็น,สำนักงานปลัดกระทรวงการพัฒนาสังคมและความมั่นคงของมนุษย์,กระทรวงการพัฒนาสังคมและความมั่นคงของมนุษย์,พม.,สป.พม.,สป.,ข้อมูลด้านสังคม,ข้อมูลทางสังคม,ข้อมูลสังคม,คนพิการ,สภาพปัญหาคนพิการในท้องถิ่น,ปัญหาคนพิการ,คนพิการในท้องถิ่น,คนพิการ,จดทะเบียนคนพิการ,คนพิการที่ถูกทอดทิ้ง'));
	...
	public function family()
    {
		...
		else
		{
			...
			$this->template->title('รายงานปัญหาครอบครัวในท้องถิ่น ระบบฐานข้อมูลทางสังคม สป.พม.');
			$this->template->append_metadata( meta('keywords','ระบบฐานข้อมูลทางสังคม,ระบบฐานข้อมูลด้านสังคม,ฐานข้อมูลด้านสังคม,ฐานข้อมูลทางสังคม,กลุ่มเป้าหมาย,เชิงประเด็น,สำนักงานปลัดกระทรวงการพัฒนาสังคมและความมั่นคงของมนุษย์,กระทรวงการพัฒนาสังคมและความมั่นคงของมนุษย์,พม.,สป.พม.,สป.,ปัญหาครอบครัวในท้องถิ่น,ปัญหาครอบครัว,ครอบครัว'));
	...
	public function older()
    {
       ...
       JOIN PROVINCES ON PROVINCES.ID = FORM_ALL.PROVINCE_ID
		...
		else
		{
			...
			$this->template->title('รายงานปัญหาผู้สูงอายุในท้องถิ่น ระบบฐานข้อมูลทางสังคม สป.พม.');
			$this->template->append_metadata( meta('keywords','ระบบฐานข้อมูลทางสังคม,ระบบฐานข้อมูลด้านสังคม,ฐานข้อมูลด้านสังคม,ฐานข้อมูลทางสังคม,กลุ่มเป้าหมาย,เชิงประเด็น,สำนักงานปลัดกระทรวงการพัฒนาสังคมและความมั่นคงของมนุษย์,กระทรวงการพัฒนาสังคมและความมั่นคงของมนุษย์,พม.,สป.พม.,สป.,ผู้สูงอายุ,ปัญหาผู้สูงอายุในท้องถิ่น,ผู้สูงอายุในท้องถิ่น,ผู้สูงอายุช่วยเหลือตัวเองไม่ได้,ผู้สูงอายุยากจน'));
	...
	public function issue1()
    {
		...
		else
		{
			...
			$this->template->title('รายงานปัญหาด้านที่อยู่อาศัยและสิ่งแวดล้อมในท้องถิ่น ระบบฐานข้อมูลทางสังคม สป.พม.');
			$this->template->append_metadata( meta('keywords','ระบบฐานข้อมูลทางสังคม,ระบบฐานข้อมูลด้านสังคม,ฐานข้อมูลด้านสังคม,ฐานข้อมูลทางสังคม,กลุ่มเป้าหมาย,เชิงประเด็น,สำนักงานปลัดกระทรวงการพัฒนาสังคมและความมั่นคงของมนุษย์,กระทรวงการพัฒนาสังคมและความมั่นคงของมนุษย์,พม.,สป.พม.,สป.,ข้อมูลด้านสังคม,ข้อมูลทางสังคม,ข้อมูลสังคม,ท้องถิ่น,ปัญหาที่อยู่อาศัย,ปัญหาด้านที่อยู่อาศัยและสิ่งแวดล้อมในท้องถิ่น,ปัญหาในท้องถิ่น,ปัญหาสิ่งแวดล้อม'));
	...
	public function issue2()
    {
		...
		else
		{
			...
			$this->template->title('รายงานปัญหาด้านสุขภาพอนามัยในท้องถิ่น ระบบฐานข้อมูลทางสังคม สป.พม.');
			$this->template->append_metadata( meta('keywords','ระบบฐานข้อมูลทางสังคม,ระบบฐานข้อมูลด้านสังคม,ฐานข้อมูลด้านสังคม,ฐานข้อมูลทางสังคม,กลุ่มเป้าหมาย,เชิงประเด็น,สำนักงานปลัดกระทรวงการพัฒนาสังคมและความมั่นคงของมนุษย์,กระทรวงการพัฒนาสังคมและความมั่นคงของมนุษย์,พม.,สป.พม.,สป.,ข้อมูลด้านสังคม,ข้อมูลทางสังคม,ข้อมูลสังคม,ท้องถิ่น,ปัญหาด้านสุขภาพอนามัยในท้องถิ่น,ปัญหาสุขภาพ,ปัญหาสุขภาพอนามัย,ปัญหาอนามัยในท้องถิ่น,ปัญหาครัวเรือน,ติดสุราเรื้อรัง,ติดสุรา,ติดยาเสพติด,ประชาชนเจ็บป่วย,ประชาชนเสียชีวิตจากโรค,โรคร้ายแรง'));
	...
	public function issue3()
    {
		...
		else
		{
			...
			$this->template->title('รายงานปัญหาด้านการศึกษาในท้องถิ่น ระบบฐานข้อมูลทางสังคม สป.พม.');
			$this->template->append_metadata( meta('keywords','ระบบฐานข้อมูลทางสังคม,ระบบฐานข้อมูลด้านสังคม,ฐานข้อมูลด้านสังคม,ฐานข้อมูลทางสังคม,กลุ่มเป้าหมาย,เชิงประเด็น,สำนักงานปลัดกระทรวงการพัฒนาสังคมและความมั่นคงของมนุษย์,กระทรวงการพัฒนาสังคมและความมั่นคงของมนุษย์,พม.,สป.พม.,สป.,ข้อมูลด้านสังคม,ข้อมูลทางสังคม,ข้อมูลสังคม,ท้องถิ่น,ปัญหาด้านการศึกษาในท้องถิ่น,ปัญหาการศึกษา,ปัญหาท้องถิ่น,เด็กออกกลางคัน,เด็กไม่ได้ศึกษาต่อ,เด็กตกงาน,'));
	...
	public function issue4()
    {
		...
		else
		{
			...
			$this->template->title('รายงานปัญหาด้านการมีงานทำและรายได้ในท้องถิ่น ระบบฐานข้อมูลทางสังคม สป.พม.');
			$this->template->append_metadata( meta('keywords','ระบบฐานข้อมูลทางสังคม,ระบบฐานข้อมูลด้านสังคม,ฐานข้อมูลด้านสังคม,ฐานข้อมูลทางสังคม,กลุ่มเป้าหมาย,เชิงประเด็น,สำนักงานปลัดกระทรวงการพัฒนาสังคมและความมั่นคงของมนุษย์,กระทรวงการพัฒนาสังคมและความมั่นคงของมนุษย์,พม.,สป.พม.,สป.,ข้อมูลด้านสังคม,ข้อมูลทางสังคม,ข้อมูลสังคม,ท้องถิ่น,ปัญหาด้านการมีงานทำและรายได้ในท้องถิ่น,งานทำในท้องถิ่น,รายได้น้อยมีหนี้สิน,ประชาชนมีรายได้น้อย'));
	...
	public function issue5()
    {
		...
		else
		{
			...
			$this->template->title('รายงานปัญหาด้านความไม่ปลอดภัยในชีวิตและทรัพย์สินในท้องถิ่น ระบบฐานข้อมูลทางสังคม สป.พม.');
			$this->template->append_metadata( meta('keywords','ระบบฐานข้อมูลทางสังคม,ระบบฐานข้อมูลด้านสังคม,ฐานข้อมูลด้านสังคม,ฐานข้อมูลทางสังคม,กลุ่มเป้าหมาย,เชิงประเด็น,สำนักงานปลัดกระทรวงการพัฒนาสังคมและความมั่นคงของมนุษย์,กระทรวงการพัฒนาสังคมและความมั่นคงของมนุษย์,พม.,สป.พม.,สป.,ข้อมูลด้านสังคม,ข้อมูลทางสังคม,ข้อมูลสังคม,ปัญหาด้านความไม่ปลอดภัยในชีวิตและทรัพย์สินในท้องถิ่น,ความไม่ปลอดภัย,ชีวิตและทรัพย์สินไม่ปลอดภัย,ข้อมูลความไม่ปลอดภัย,ข้อมูลท้องถิ่น'));
	...
	public function issue6()
    {
		...
		else
		{
			...
			$this->template->title('รายงานปัญหาด้านวัฒนธรรมและจริยธรรมในท้องถิ่น ระบบฐานข้อมูลทางสังคม สป.พม.');
			$this->template->append_metadata( meta('keywords','ระบบฐานข้อมูลทางสังคม,ระบบฐานข้อมูลด้านสังคม,ฐานข้อมูลด้านสังคม,ฐานข้อมูลทางสังคม,กลุ่มเป้าหมาย,เชิงประเด็น,สำนักงานปลัดกระทรวงการพัฒนาสังคมและความมั่นคงของมนุษย์,กระทรวงการพัฒนาสังคมและความมั่นคงของมนุษย์,พม.,สป.พม.,สป.,ข้อมูลด้านสังคม,ข้อมูลทางสังคม,ข้อมูลสังคม,ปัญหาด้านวัฒนธรรมและจริยธรรมในท้องถิ่น'));
