	...
	$(document).ready(function(){
		$(".btn_delete").click(function(){
			if(confirm('ลบรายการนี้ ? ')){
				...
				window.location='setting/support_section/delete/'+hdid;
			}
		})
	})
</script>
<h2>ตั้งค่าข้อมูลหลัก - หน่วยงานสนับสนุน</h2>
<form method="get" >
<div id="search">
  <div id="searchBox">
...
<?php if(permission('support_section','add')):?>
<div id="btnBox">
	<input type="button" title="เพิ่มรายการ"  value=" " onclick="document.location='setting/support_section/form'" class="btn_add"/>
</div>
<?php endif;?>
...
<tr  <? if($rowStyle =='')$rowStyle = 'class="odd"';else $rowStyle = "";echo $rowStyle;?>>
  ...
  <td>
  	...
  	<?php if(permission('support_section','edit')):?>
  	<input type="button" name="button9" id="button9" title="แก้ไขรายการนี้" value=" " class="btn_edit vtip"  onclick="window.location='setting/support_section/form/<?=$item['id'];?>'" />
  	<?php endif;?>
  	<?php if(permission('support_section','delete')):?>
