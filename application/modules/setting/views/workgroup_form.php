...
<h4><?=$section_name;?></h4>
<form method="post" enctype="multipart/form-data" action="setting/section/workgroup_save">
<table class="tbadd">

<tr>
  <th>ชื่อฝ่าย/กลุ่มงาน <span class="Txt_red_12"> *</span></th>
...
<tr>
  ...
  <td><?=form_dropdown('pid',get_option('id','title','SECTION','PID =0 ORDER BY title '),@$pid,'','--เลือกสังกัดหน่วยงาน--');?></td>
</tr>
<tr>
