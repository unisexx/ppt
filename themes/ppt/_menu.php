		...
		<ul>
			<li><a href="#">เด็กและเยาวชน</a>
                <ul>
                    ...
                    <li><a>//เด็กที่ผู้ปกครองไม่สามารถเลี้ยงดูได้ <img src="themes/ppt/images/ico_question.png" width="16" height="16" title="แบบ อปท.1" class="vtip ico_quest" /></a></li>
            ...
            <li><a href="#">สตรี</a>
                <ul>
                    <li><a href="#">//สตรีที่ถูกละเมิดทางเพศ <img src="themes/ppt/images/ico_question.png" width="16" height="16" title="แบบ อปท.1" class="vtip ico_quest" /></a></li>
                    <li><a href="#">//สตรีที่ถูกทำร้ายร่างกายและจิตใจ <img src="themes/ppt/images/ico_question.png" width="16" height="16" title="แบบ อปท.1" class="vtip ico_quest" /></a></li>
                    <li><a href="#">//สตรีหม้ายที่ต้องเลี้ยงดูบุตรเพียงลำพัง <img src="themes/ppt/images/ico_question.png" width="16" height="16" title="แบบ อปท.1" class="vtip ico_quest" /></a></li>
                </ul>
        	</li>
            <li><a href="#">คนพิการ</a>
                <ul>
		...
		<ul>
            <li><a href="#">ครอบครัว</a>
                <ul>
                    ...
                    <li><a href="#">ครัวเรือนที่อาศัยอยู่ในสภาพแวดล้อมไม่เหมาะสมและสมควรได้รับความช่วยเหลือ <img src="themes/ppt/images/ico_question.png" width="16" height="16" title="แบบ อปท.1" class="vtip ico_quest" /></a></li>
                    <li><a href="#">ครัวเรือนทีมีสภาพที่อยู่อาศัยไม่มั่นคงและสมควรได้รับความช่วยเหลือ <img src="themes/ppt/images/ico_question.png" width="16" height="16" title="แบบ อปท.1" class="vtip ico_quest" /></a></li>
                    <li><a href="#">ครัวเรือนที่อาศัยอยู่ในพื้นที่เสี่ยงภัยทางธรรมชาติ ในระดับที่เป็นอันตรายต่อชีวิตและทรัพย์สิน <img src="themes/ppt/images/ico_question.png" width="16" height="16" title="แบบ อปท.1" class="vtip ico_quest" /></a></li>
                    <li><a href="#">ครัวเรือนที่ไม่มีกรรมสิทธิ์ในที่อยู่อาศัย เช่น อาศัยอยู่ในพื้นที่สาธารณะที่ราษฎร์พัสดุ ภายในบริเวณวัด ที่เช่า เป็นต้น <img src="themes/ppt/images/ico_question.png" width="16" height="16" title="แบบ อปท.1" class="vtip ico_quest" /></a></li>
            ...
            <li><a href="#">ผู้สูงอายุ</a>
                <ul>
                    ...
                    <li><a href="#">//ผู้สูงอายุที่ยังไม่ได้แจ้งจดทะเบียนเพื่อรับเบี้ยยังชีพได้ตามกำหนด (มีเอกสารหลักฐานครบถ้วน) <img src="themes/ppt/images/ico_question.png" width="16" height="16" title="แบบ อปท.1" class="vtip ico_quest" /></a></li>
                    <li><a href="#">//ผู้สูงอายุที่ช่วยเหลือตัวเองไม่ได้และสมควรได้รับความช่วยเหลือ (ผู้สูงอายุที่อยู่ตามลำพังและไม่มีผู้ดูแล) <img src="themes/ppt/images/ico_question.png" width="16" height="16" title="แบบ อปท.1" class="vtip ico_quest" /></a></li>
                    <li><a href="#">//ผู้สูงอายุที่ไม่สามารถเข้าถึงบริการ/กิจกรรมสำหรับผู้สูงอายุในด้านต่าง ๆ เช่น ด้านอาชีพ สุขภาพ นันทนาการ เป็นต้น <img src="themes/ppt/images/ico_question.png" width="16" height="16" title="แบบ อปท.1" class="vtip ico_quest" /></a></li>
                    <li><a href="#">//ผู้สูงอายุที่ถูกทำร้ายร่างกายและจิตใจ <img src="themes/ppt/images/ico_question.png" width="16" height="16" title="แบบ อปท.1" class="vtip ico_quest" /></a></li>
                    <li><a href="#">//ผู้สูงอายุที่ไม่มีชื่อในทะเบียนบ้าน/ไม่มีบัตรประชาชน <img src="themes/ppt/images/ico_question.png" width="16" height="16" title="แบบ อปท.1" class="vtip ico_quest" /></a></li>
                    <li><a href="#">//ผู้สูงอายุที่ยากจนและมีภาระต้องเลี้ยงดูบุตรหลาน <img src="themes/ppt/images/ico_question.png" width="16" height="16" title="แบบ อปท.1" class="vtip ico_quest" /></a></li>
                </ul>
        	</li>
...
ชื่อ-นามสกุล แกนนำเครือข่ายด้านการพัฒนาสังคมระดับตำบล/อื่นๆ หมายเลขโทรศัพท์" class="vtip ico_quest" /></a></li>-->
					<li><a>//ประชาชนที่ติดสุราเรื้อรัง <img src="themes/ppt/images/ico_question.png" width="16" height="16" title="แบบ อปท.1" class="vtip ico_quest" /></a></li>
					<li><a>//ประชาชนที่ติดสารเสพติดร้ายแรง เช่น ยาบ้า ยาอี สารระเหย กัญชา เป็นต้น <img src="themes/ppt/images/ico_question.png" width="16" height="16" title="แบบ อปท.1" class="vtip ico_quest" /></a></li>
					<li><a>//ประชาชนที่ติดเชื้อเอดส์/ป่วยเป็นโรคเอดส์และสมควรได้รับความช่วยเหลือ (ทั้งที่ได้รับความช่วยเหลือแล้วและยังไม่ได้รับความช่วยเหลือ) <img src="themes/ppt/images/ico_question.png" width="16" height="16" title="แบบ อปท.1" class="vtip ico_quest" /></a></li>
					<li><a>//ประชานที่ติดโรคระบาดในรอบปี เช่น โรคไข้เลือดออก โรคอหิวาตกโรค โรคไข้หวัดนก โรคฉี่หนู เป็นต้น <img src="themes/ppt/images/ico_question.png" width="16" height="16" title="แบบ อปท.1" class="vtip ico_quest" /></a></li>
					...
					<li><a>//ร้านค้าที่ขายเหล้า/บุหรี่ อยู่ในบริเวณใกล้เคียงสถานศึกษาและศาสนสถาน  <img src="themes/ppt/images/ico_question.png" width="16" height="16" title="แบบ อปท.1" class="vtip ico_quest" /></a></li>
					<li><a>//ร้านสื่อลามก /ร้านเกมส์/ร้านอินเตอร์เน็ตภายในท้องถิ่น  <img src="themes/ppt/images/ico_question.png" width="16" height="16" title="แบบ อปท.1" class="vtip ico_quest" /></a></li>
					<li><a>//กลุ่มเครือข่ายที่ยังมีปัญหาเรื่องความปรองดองและจำเป็นต้องมีการจัดการให้เกิดความสมานฉันท์  <img src="themes/ppt/images/ico_question.png" width="16" height="16" title="แบบ อปท.1" class="vtip ico_quest" /></a></li>
					<li><a>//คนที่ถูกเลิกจ้างและว่างงานไม่มีรายได้  <img src="themes/ppt/images/ico_question.png" width="16" height="16" title="แบบ อปท.1" class="vtip ico_quest" /></a></li>
					<li><a>//แรงงานต่างด้าวในท้องถิ่นที่จดทะเบียนแล้วถิ่น  <img src="themes/ppt/images/ico_question.png" width="16" height="16" title="แบบ อปท.1" class="vtip ico_quest" /></a></li>
