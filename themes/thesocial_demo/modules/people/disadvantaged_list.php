...
<h4>ผู้ด้อยโอกาสทางสังคม <span class="gray">แบบ ผู้ด้อยโอกาส(สท.)</span></h4>
<div id="search">
  <div id="searchBox">
    ...
    <select name="select3" id="select3">
      <option>-- ทุกแขวง/ตำบล --</option>
    </select>
  <input type="submit" name="button9" id="button9" title="ค้นหา" value=" " class="btn_search" /></div>
</div>

<div id="btnBox"><input type="button" title="นำเข้าข้อมูล"  value=" " onclick="document.location='<?=basename($_SERVER['PHP_SELF'])?>?act=import'" class="btn_import"/><input type="button" title="เพิ่มรายการ"  value=" " onclick="document.location='<?=basename($_SERVER['PHP_SELF'])?>?act=disadvantaged_form'" class="btn_add"/></div>
